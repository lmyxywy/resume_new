    ...
    ////////////////背景大图片轮播
        ...
        //});
            ...
            $(document).ready(function (e) {
                var unslider00 = $('.slider_0').unslider({
                    dots: false,
                    fluid: true,
                    delay:8000
                });
                //data00 = unslider00.data('unslider');
                //$('.unslider-arrow00').click(function () {
            ...
            $(document).ready(function (e) {
                var unslider08 = $('.slider_8').unslider({
                    dots: true,
                    fluid: true,
                    delay: 2000
                });
           ...
           ///////////////////////////////////(二级导航要闻-图片视频)轮播图js
                ...
                $(document).ready(function (e) {
                    var unslider09 = $('.slider_9').unslider({
                        dots: true,
                        fluid: true,
                        delay: 2000
                    });
                    data09 = unslider09.data('unslider');
                    $('.unslider-arrow09').click(function () {
                        var fn = this.className.split(' ')[1];
                        data09[fn]();
                    });
                });
